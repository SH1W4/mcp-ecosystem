...
import { ModuleManager, UniversalBackup, UniversalSync } from '../../src/modules';

describe('MCP Ecosystem Module Integration', () => {
  let ecosystem: MCPEcosystem;
  let moduleManager: ModuleManager;

  beforeEach(() => {
    ecosystem = new MCPEcosystem('test-ecosystem');
    moduleManager = new ModuleManager(ecosystem);
  });
  ...
  describe('Module Registration', () => {
    ...
    it('should retrieve registered modules', async () => {
      ...
      expect(backup).toBeInstanceOf(UniversalBackup);
      expect(sync).toBeInstanceOf(UniversalSync);
    });
  });
